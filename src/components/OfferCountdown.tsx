  ...
  return (
    <div className="bg-pink-500/10 border border-pink-500/30 rounded-lg p-3 space-y-2">
      ...
      <div className="flex gap-2 justify-center">
        {timeLeft.days > 0 && (
          <div className="bg-pink-500 text-white rounded px-2 py-1 text-center min-w-[40px]">
      ...
      {offerCode && (
        <div className="flex items-center justify-center gap-2 pt-1">
          ...
          <Badge variant="outline" className="border-pink-500 text-pink-600 dark:text-pink-400 font-mono text-xs">
            {offerCode}
          </Badge>
        </div>
      )}
