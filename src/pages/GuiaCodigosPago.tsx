      ...
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-12">
            <Badge className="mb-4 bg-gradient-to-r from-pink-500 to-purple-500">Guía de Compra</Badge>
          ...
          <div className="space-y-6">
            ...
            {/* Beneficios */}
            <Card className="bg-gradient-to-br from-pink-50 to-purple-50 dark:from-pink-950/20 dark:to-purple-950/20 border-none">
              <CardHeader>
