            ...
            <table width="100%" cellpadding="0" cellspacing="0" style="max-width: 600px; margin: 0 auto; background-color: #ffffff;">
              <tr>
                <td style="padding: 40px 20px; text-align: center; background-color: #000000;">
                  ...
                  <p style="color: #ffffff; margin: 10px 0 0 0; font-size: 14px;">Pedidos</p>
                </td>
              </tr>
              ...
              <tr>
                <td style="padding: 40px 30px;">
                  ...
                  <p style="color: #333333; line-height: 1.6; margin: 0 0 20px 0; font-size: 16px;">
                    Gracias por hacernos saber que quieres pedir con nosotros. Nos encantará ayudarte en todo el proceso de tu compra.
                  </p>
